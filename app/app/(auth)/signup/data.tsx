  ...
  const mutation = useMutation({
    mutationFn: async () =>
      register({
        ...
        cabangId,
        // Per BE request 2026-05-23 (M23): signup-time jenis jemaat
        // assignment. Mobile cuma ask jenisJemaat (Tetap vs NewComer);
        // fulltimer status di-assign manual oleh admin di portal.
